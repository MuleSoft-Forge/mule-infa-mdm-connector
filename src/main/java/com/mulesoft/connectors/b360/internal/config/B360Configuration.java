...
@ConnectionProviders(B360BasicAuthConnectionProvider.class)
@Operations({MasterReadOperation.class, SearchOperation.class, SourceReadOperation.class, SourceSubmitOperation.class})
